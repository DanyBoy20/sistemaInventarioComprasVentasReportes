...
<form name="busc" method="post" action="salidocv2.php">
		  <table width="100%"  border="1">		  
  <tr valign="middle">
    <td align="center" background="img/blue.png" class="small_text1">Item</td>
	...
	<td align="center" background="img/blue.png" class="small_text1">Referencia</td>
	<td align="center" background="img/blue.png" class="small_text1">Status</td>
    ...
    $reso=mssql_query("SELECT idcompraventa,ncompraventa,diacv,mescv,aniocv,norefdist,statusordencv,razon_social 
                       ...
                       WHERE statusordencv <> 'Entregado' AND statusordencv <> 'Cancelada' AND statusordencv <> 'Enviada' AND idcompraventa > 0 ORDER BY idcompraventa",$cne);
	...
	$b7=$fia["razon_social"];
	echo "<tr><td class='peque2' align='center'><input type='radio' name='idocv' value='$b1' onClick='envia(this.form)'>&nbsp;</td>
