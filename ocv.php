...
?>
			...
			<table width="100%"  border="0">
  <tr>
    <td width="45%" align="right"  class="small_text1"><input type="submit" name="Nuevo" value="Nuevo" onclick="this.form.action='compvent.php'"></td>
    <td width="9%" align="center" class="small_text1"><input type="submit" name="Revisar" value="Revisar" onclick="this.form.action='ocv2.php'"></td>
    <td width="46%" align="left"  class="small_text1"><input type="submit" name="Buscar" value="Buscar" onclick="this.form.action='ocv3.php'"></td>
  </tr>
</table></form>
<hr align="center" color="#0033FF" width="100%" size="1px">
			</td>
