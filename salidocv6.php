...
<tr>
	...
	Numero de control:
	<input name='ncntrl' type='text' onBlur="MM_validateForm('ncntrl','','RisNum');return document.MM_returnValue" size="5" maxlength="2" value="<? echo $ncntrl;?>">
	A&ntilde;o:
	<select name='yer' style="font-size:.90em;">
    <option value='<? echo $yer;?>' selected><? echo $yer;?></option>
	<option value='2007'>2007</option>
	<option value='2008'>2008</option>
	</select>
	Mes:
	<select name='mnth' style="font-size:.90em;">
    <option value='<? echo $mnth;?>' selected><? echo $mnth;?></option>
...
<tr>
    ...
    <option value='<? echo $dayreal;?>' selected><? echo $dayreal;?></option>
    ...
    <option value='<? echo $mesreal;?>' selected><? echo $mesreal;?></option>
    ...
    <option value='<? echo $anioreal;?>' selected><? echo $anioreal;?></option>
	<option value='2007'>2007</option>
	<option value='2008'>2008</option>
	</select>
    </td>
...
<tr>
	...
	<td width="574" colspan="2"><input type="text" name="cpor" size="20" value="<? echo $cpor;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Direccion: </td>
	<td width="574" colspan="2"><input type="text" name="dirent" size="100" value="<? echo $dirent;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Ciudad: </td>
	<td width="574" colspan="2"><input type="text" name="ciudadent" size="100" value="<? echo $ciudadent;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Estado: </td>
	<td width="574" colspan="2"><input type="text" name="estadoent" size="100" value="<? echo $estadoent;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Entregado a:</td>
	<td width="574" colspan="2"><input type="text" name="entregaa" size="100" value="<? echo $entregaa;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Recibido por:</td>
	<td width="574" colspan="2"><input type="text" name="recibidox" size="100" value="<? echo $recibidox;?>"></td>
</tr>
<tr>
	...
	<td width="574" colspan="2"><input type="text" name="nom" size="100" value="<? echo $nom;?>"></td>
</tr>
<tr>
	<td width="94" align="right">R.F.C. : </td>
	<td width="574" colspan="2"><input type="text" name="rfcfactura" size="100" value="<? echo $rfcfactura;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Direccion:</td>
	<td width="574" colspan="2"><input type="text" name="dirfactura" size="100" value="<? echo $dirfactura;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Ciudad:</td>
	<td width="574" colspan="2"><input type="text" name="ciudadfactura" size="100" value="<? echo $ciudadfactura;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Estado:</td>
	<td width="574" colspan="2"><input type="text" name="estadofactura" size="100" value="<? echo $estadofactura;?>"></td>
</tr>
<tr>
	<td width="94" align="right">No. Factura: </td>
	<td width="574" colspan="2"><input type="text" name="numerofact" size="100" value="<? echo $numerofact;?>"></td>
</tr>
<tr>
	<td width="94" align="right">Comentarios: </td>
	<td width="574" colspan="2"><input type="text" name="comenta" size="100" value="<? echo $comenta;?>"></td>
</tr>
<tr>
