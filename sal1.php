...
$resul2=mssql_query("SELECT DISTINCT linea
					 ...
					 INNER JOIN salordncv1 ON salordncv1.idsalidaocv=salordncv2.idsalidaocv
					 WHERE salordncv1.messalcv='$mes' AND salordncv1.aniosalcv='$anio'",$con);
...
$resul=mssql_query("SELECT idproduct,linea,descripcion,cantisalida,serial,numpedimento4,diasalcv,messalcv,aniosalcv,ncompraventa,norefdist,razon_social
					...
					WHERE salordncv1.messalcv='$mes' AND salordncv1.aniosalcv='$anio' AND inventa1.linea='$b1'
