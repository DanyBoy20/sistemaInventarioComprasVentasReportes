...
<BODY onLoad="mover()" onUnload="btnclose()" background="img/fondo.gif" leftMargin=0 topMargin=0 marginwidth="0" marginheight="0" bottommargin="0" bgproperties="fixed"><center>
  <table width="804" height="204" align="center" cellpadding="0" cellspacing="0" class="bordet">
    <tr>
	...
	<tr>
      <td height="19" valign="top" bgcolor="#FFFFFF">
...
?>
    ...
    <tr>
      <td background="../img/blue.png" class="small_text1" align="center">Lista de Precios</td>
    </tr>
	<tr>
      <td height="19" valign="top" bgcolor="#FFFFFF">
	  <table width="100%"  border="0" class="1_main_navigation">
  <tr>
    <td width="38%">
	<script language="javascript">
    ...
    <td width="22%" rowspan="4" valign="top" class="small_text1">
	<FORM>
	<input type="radio" name="selectname" onClick="JavaScript:radio_input('lpproducto.php')">X PRODUCTO<BR>
	<input type="radio" name="selectname" onClick="JavaScript:radio_input('lplinea.php')">X LINEA<BR>
	<input type="radio" name="selectname" onClick="JavaScript:radio_input('lpdist.php')">X DISTRIBUIDOR<BR>
	<input type="radio" name="selectname" onClick="JavaScript:radio_input('lpea.php')">ENERGIA AMBIENTAL<BR>
	<input type="radio" name="selectname" onClick="JavaScript:radio_input('lptodos.php')">TODOS
	</FORM>
	</td>
    <td width="40%">&nbsp;</td>
  </tr>
