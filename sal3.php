...
WHERE (salordncv1.idcompraventa=ordencv1.idcompraventa 
AND ordencv1.cve_distribuidor=distribuidores.cve_distribuidor
AND distribuidores.cve_distribuidor=$dtr 
AND salordncv1.messalcv='$mes' AND salordncv1.aniosalcv='$anio')",$conn);
$g=1;
