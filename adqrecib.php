...
<form name="busc" method="post" action="adqrecib2.php">
		  <table width="100%"  border="1">		  
  <tr valign="middle">
    <td align="center" background="img/blue.png" class="small_text1">&nbsp;</td>
	<td align="center" background="img/blue.png" class="small_text1">No. Orden</td>
	<td align="center" background="img/blue.png" class="small_text1">Orden Pedido</td>
	<td align="center" background="img/blue.png" class="small_text1">Fecha de Creacion</td>
	<td align="center" background="img/blue.png" class="small_text1">Fecha de Envio</td>
	<td align="center" background="img/blue.png" class="small_text1">Status Orden</td>
	</tr>   
        <?
	$cne=mssql_connect("SISTEMAS","","");
    mssql_select_db("baseDatos");
	mssql_query("UPDATE intentos SET idintento=0",$cne);
    $reso=mssql_query("SELECT idadquisicion,ordendped,nadquisicion,diaadqui,mesadqui,anioadqui,fechaenvioadqui2,statusadq
	                     FROM ordenadq1 WHERE statusadq = 'Entregado' AND idadquisicion > 0 ORDER BY idadquisicion",$cne);
	...
	$b6=$fia["statusadq"];
	echo "<tr><td class='peque2' align='center'><input type='radio' name='idadq' value='$b1' onClick='envia(this.form)'>&nbsp;</td>
		  <td class='peque2' align='center'>$b2</td>
		  <td class='peque2' align='center'>$odp</td>
		  <td class='peque2' align='center'>$b3/$b4/$b5</td>
		  <td class='peque2' align='center'>$fenv</td>
