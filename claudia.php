...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=no,location=0,statusbar=0,menubar=0,resizable=no,width=880,height=410');");
}
</script>
...
<embed src="img/TRANS.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="800" height="134">
</embed>
</object></noscript>
        </div></td>
    </tr>
              ...
              <table width="100%"  border="0">
                <tr>
                 ...
                 <tr>
                  ...
                  href="claudia.php">Inicio</A></td>
                  <td width="80%" rowspan="15" class="small_text1">
<?
...
?>
                ...
                <tr>
                  <td><A class=main_navigation 
                  href="javascript:popUp3('newproduct2.php')">Alta Productos</A></td>
                </tr>
				<tr>
                  <td><A class=main_navigation 
