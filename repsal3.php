...
$busc=mssql_query("SELECT idsalidaocv,foliosalocv from salordncv1 where foliosalocv='$prd'",$conn);
$busc1=mssql_fetch_array($busc);
$bsc=$busc1["idsalidaocv"];
$bsc1=$busc1["foliosalocv"];
if($bsc1 != $prd){
echo "<script>alert('ERROR ... NO EXISTE ESE FOLIO, INTENTE NUEVAMENTE')</SCRIPT>";
echo "<script>window.location='repsal1.php'</script>";
}
echo "<table border=1 width='100%' cellpadding='2' cellspacing='2'>
		<tr>
			<td background='img/blue1.jpg' align='left'>
				<SPAN class='navigation_heading'>REPORTE DE SALIDAS - No.: $prd</SPAN>
			</td>
		</tr>
		<tr>
			<td align='left'>
...
WHERE (salordncv1.idcompraventa=ordencv1.idcompraventa AND salordncv1.foliosalocv='$prd')",$conn);
$g=1;
...
echo "<tr>
		...
		<tr>
			...
			<td class='peque2' align='center'>&nbsp;$nref</td>
...
echo "</td></tr><tr><td colspan='4' background='img/blue1.jpg' align='left' style='border-style:none;'><SPAN class='navigation_heading'>CMD&nbsp;$bsc</SPAN></td>
