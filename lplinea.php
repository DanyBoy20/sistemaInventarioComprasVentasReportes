...
<BODY onLoad="mover()" onUnload="btnclose()" background="img/fondo.gif" leftMargin=0 topMargin=0 marginwidth="0" marginheight="0" bottommargin="0" bgproperties="fixed"><center>
  <table width="804" height="202" align="center" cellpadding="0" cellspacing="0" class="bordet">
    <tr>
...
?>
				...
				<tr>
                  <td><A class=main_navigation 
                  href="precios.php">Precios productos</A></td>
                </tr>
				<tr>
                  <td><A class=main_navigation 
	...
	<tr>
      <td background="../img/blue.png" class="small_text1" align="center">Precio por linea de productos</td>
    </tr>
	<tr>
      <td height="19" valign="top" bgcolor="#FFFFFF">&nbsp;
