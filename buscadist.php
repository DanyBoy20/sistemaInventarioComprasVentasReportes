...
?>
  ...
  <tr>
	...
	$conx=mssql_connect("SISTEMAS","","");
		  mssql_select_db("baseDatos");
		  $rest=mssql_query("SELECT cve_distribuidor,tipodist,razon_social,nombre,apellido_p,
		               apellido_m,telefono,fax,ciudad,direccion,estado,email,logo,contra
		  		       FROM distribuidores WHERE cve_distribuidor='$clave'",$conx);
    ...
    <td width="37%" align="right"></td>
		  ...
		  <tr bgcolor="#FFFFFF">
		  <td>
		  <form name="formu" method="post" action="actua.php">
		  <table width="100%"  border="0">
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="rs" value="<? echo $a3;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Tipo Distribuidor</td>
    <td><select style="font-size:8pt;font-family:Arial;font-weight:bold;" name="tip">
	<option value="<? echo $a2;?>" selected><? echo $a2;?></option>
	...
	<option value="smayorista">Swimquip</option>
	</select>	
	</td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Nombre</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="nm" value="<? echo $a4;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Ap. Paterno</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="ap" value="<? echo $a5;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Ap. Materno</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="am" value="<? echo $a6;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Telefono</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="tl" value="<? echo $a7;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Fax</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="fx" value="<? echo $a8;?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="dr" value="<? echo $b1;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Estado</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="es" value="<? echo $b2;?>"></td>
  </tr>
  <tr>
    <td background="img/blue1.jpg" align="left" class="peque">Email</td>
    <td><input type="text" size="100" style="font-size:8pt;font-family:Arial;font-weight:bold;" name="em" value="<? echo $b3;?>"></td>
  </tr>
  <tr>
    <td><input type="hidden" name="logo" value="<? echo $b4;?>"><input type="hidden" name="ps" value="<? echo $b5;?>"></td>
