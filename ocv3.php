...
<!--
<tr><td colspan="2">
<a class=main_navigation href="dos.php?ursec=<? echo $cod;?>&ndn=<? echo $nordn;?>&idadq=<? echo $orden;?>&secur=<? echo session_id();?>&w=<? echo $w;?>">
Modificar Orden
</a>
</td></tr>
-->
...
mssql_select_db("baseDatos");
$resut11=mssql_query("SELECT tipodist FROM distribuidores WHERE cve_distribuidor=$dtr AND tipodist <> 'no'",$cone);
...
<td colspan="3" align="center">
	...
	<input type="hidden" name="orden" value="<? echo $orden;?>"><input type="hidden" name="dtr" value="<? echo $dtr;?>">
