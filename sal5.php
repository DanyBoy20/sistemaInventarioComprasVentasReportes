...
echo "<table border=1 width='100%' cellpadding='2' cellspacing='2'>
		<tr>
			<td background='img/blue1.jpg' align='left'>
				<SPAN class='navigation_heading'>REPORTE DE SALIDAS - No. ORDEN DE COMPRA :  $anio</SPAN>
			</td>
		</tr>
		<tr>
			<td align='left'>
...
$result5=mssql_query("SELECT salordncv1.idsalidaocv,salordncv1.foliosalocv,salordncv1.idcompraventa,salordncv1.diasalcv,salordncv1.messalcv,salordncv1.aniosalcv,
       ...
       salordncv1.rfcfactura,salordncv1.nofacturaEA,
       ordencv1.idcompraventa AS idcv,ordencv1.ncompraventa,ordencv1.diacv,ordencv1.mescv,ordencv1.aniocv,
       ordencv1.norefdist,ordencv1.statusordencv,
       distribuidores.razon_social                           
FROM salordncv1,ordencv1,distribuidores
WHERE (salordncv1.idcompraventa=ordencv1.idcompraventa AND ordencv1.cve_distribuidor=distribuidores.cve_distribuidor
AND distribuidores.cve_distribuidor=$dtr 
AND ordencv1.ncompraventa='$orden')
ORDER BY salordncv1.fechsalocv",$conn);
$g=1;
...
echo "<tr>
		...
		<tr>
			...
			<td class='peque2' align='center' colspan='3'>&nbsp;$n27</td>
...
<tr>
	  ...
	  <tr>
*/
echo "<td width='100%' style='text-align:left;' colspan='6'><SPAN class='navigation_heading'>Series - Pedimento</SPAN></td><tr><td colspan='6'>";
