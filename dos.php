...
<BODY background="img/fondo.gif" leftMargin=0 topMargin=0 marginwidth="0" marginheight="0" bottommargin="0" bgproperties="fixed"><center>
  <table width="804" height="272" align="center" cellpadding="0" cellspacing="0" class="bordet">
    <tr>
      <td height="134">
      <div align="center">
            <script type="text/javascript">
...
mssql_query("UPDATE intentos2 SET idintento=0",$conexion);
...
$mese=$me;
?>
<A class=main_navigation href="ocv5.php?ursec=<? echo $cod;?>&nordn=<? echo $nordn;?>&orden=<? echo $orden;?>&secur=<? echo session_id();?>&w=<? echo $w;?>">Regresar a Orden</A>
</td></tr>
				<tr><td colspan="2">
...
$estad=$ficha4["estado"];
mssql_close($conn);
echo "<form name='formulario' method='post' action='dos1.php'>
...
<tr>
	...
	<td align='right' valign='middle' background='img/blue.png'><font face='Arial' size='0.2'><b>
		...
		<td colspan='7'>			
<select name='trs' style='font-size:.90em;'>
...
<tr>
	...
	<input type='text' name='cporte' value='$crtprte'></b></font>	
	</td>
</tr>
<tr>
	<td align='right' valign='middle' background='img/blue.png'><font face='Arial' size='0.2'><b>
...
$numerofilas=mssql_num_rows($result); 
   ...
   while ($fila2=mssql_fetch_array($result)){ 
	  ...
	  echo "<td  class='peque' align='center'><a href='elimn3.php?idadq=$idadq&idproduct=" . $fila2['cod'] . "'>Eliminar</a></td>";
	  }
...
echo "</select><br><br>
   ...
   <input type=hidden name='nommes' value='$mese'>
   </td></tr>";
