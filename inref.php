...
$mese=$me;
?>
	<SPAN class="navigation_heading">Ingreso de refacciones en Almacen D.F.</SPAN></td>
    </tr>
	<tr>
	<td align="center">
<form name="formulario" method="post" action="inref2.php">
...
<tr> 
 <td width="168" align="right">No. de serie (si existe):</td>
 <td width="531" valign="middle"> 
...
<tr> 
 ...
 <td width="531" valign="middle"> 
 <input type="text" name="comenta" size="50" value="refacciones">
