...
Ver Orden Completa
  ...
  <tr>
    ...
    $redo=mssql_query("SELECT norden FROM orden1 WHERE idorden=$orden",$conon);
...
<input type="submit" name="cancela" value="Cancelar Orden" onclick="this.form.action='canceln.php'">
  </td>
 </tr>
</table>
