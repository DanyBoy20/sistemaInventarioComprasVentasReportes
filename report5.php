...
echo "<table border=1 width='100%' cellpadding='2' cellspacing='2'>
		<tr>
			<td background='img/blue1.jpg' align='left'>
				<SPAN class='navigation_heading'>REPORTE ORDENES DE COMPRA A&ntilde;O : $anio</SPAN>
			</td>
		</tr>
		<tr>
			<td align='left'>
...
$result5=mssql_query("SELECT idcompraventa,ncompraventa,diacv,mescv,aniocv,direnviocv,ciudadcv,estadocv,norefdist,fechestentregacv1,statusordencv 
FROM ordencv1 
WHERE statusordencv LIKE '$tips' AND cve_distribuidor=$distri AND aniocv='$anio' 
ORDER BY fechaocv1",$conn);					
$d=1;
...
$result87=mssql_query("SELECT razon_social FROM distribuidores WHERE cve_distribuidor=$distri",$conn);
$fichaw=mssql_fetch_array($result87);
$n8=$fichaw["razon_social"];
echo "<table border=1 width='100%' cellpadding='2' cellspacing='2'>
	  <tr>
