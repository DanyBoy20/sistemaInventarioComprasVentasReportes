...
$result5=mssql_query("SELECT receqpadq1.idreciboadq,receqpadq1.folioadq,receqpadq1.idadquisicion AS idadqrecibo,receqpadq1.diarecadq,
					  ...
					  WHERE (ordenadq1.idadquisicion=receqpadq1.idadquisicion AND receqpadq1.mesrecadq='$mes' AND receqpadq1.aniorecadq='$anio')",$conn);
$g=1;
...
echo "</td></tr><tr><td colspan='8' background='img/blue1.jpg' align='right'><SPAN class='navigation_heading'>CMD&nbsp;$g</SPAN></td></tr>";
echo "</table>";
