...
?>
  ...
  <tr>
	...
	$conx=mssql_connect("SISTEMAS","","");
		  mssql_select_db("baseDatos");
		  mssql_query("UPDATE proveedores 
		               SET idtransporte='$clave',razonsocialtrns='$rsoc',tipoproveedor='$tp',
					   nomcontactotrns='$ct1',nomcontacto2='$ct2',nomcontacto3='$ct3',nomcontacto4='$ct4',
		               direcciontrns='$dir',ciudadtrns='$ciu',estadotrns='$esta',telefonotrns='$tls',
					   faxtrns='$faxes',RFCtrns='$rffc',emailtrns='$em',comentariostrns='$cnm' WHERE idtransporte='$clave'",$conx);  
    mssql_close($conx);		  
	?>
	</td>
