...
?>
  ...
  <tr>
	...
	$conx=mssql_connect("SISTEMAS","","");
		  mssql_select_db("baseDatos");
		  mssql_query("UPDATE distribuidores 
		               SET cve_distribuidor='$clave',tipodist='$tip',razon_social='$rsoc',nombre='$nom',apellido_p='$apat',
		               apellido_m='$amat',telefono='$tel',fax='$fax',ciudad='$ciud',
					   direccion='$direcc',estado='$esta',email='$correo',logo='$log',contra='$pass' WHERE cve_distribuidor='$clave'",$conx);  
    mssql_close($conx);		  
	?>
	</td>
    <td width="26%" background="img/blue1.jpg" class="small_text1" align="center">Registro Actualizado</td>
    <td width="37%" align="right"><A class=main_navigation 
                  href="distribuidoresc.php">Actualizar Otro Registro</A></td>
  </tr>  
</table>
		  </td>
		  </tr>
